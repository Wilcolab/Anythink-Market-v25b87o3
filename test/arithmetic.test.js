...
describe('Power', function () {
    ...
    it('raises a positive integer to a negative integer exponent', function (done) {
    ...
    it('raises a negative base to a non-integer exponent (should return null)', function (done) {
